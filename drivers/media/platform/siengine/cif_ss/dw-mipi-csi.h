...
#define MAX_VC_NUM  4
#define DW_COMPATIBLE_NAME "dw-csi"

#define DW_CSI_AXI_CLK  "cisp-axi-clk"
#define DW_CSI_APB_CLK  "cisp-apb-clk"
#define DW_CSI_AHB_CLK  "cisp-ahb-clk"
#define DW_CSI_PIXEL_CLK  "cisp-pixel-clk"
#define DW_CSI_ISP_CORE_CLK  "cisp-isp-core-clk"
...
struct dw_csi {
	...
	struct mipi_fmt *fmt;
	struct v4l2_mbus_framefmt format[4];
...
void dw_mipi_csi_start_ipin(struct dw_csi *csi_dev, int ipi_channel);
