...
/*GPU0 register base address*/
#define GPU0_REG_BASE		0xe5000000

#define GPU0_SYS_CTRL_REGS	0x700000

/*CR_WRAP register base address*/
#define CR_WRAP_TOP		0x58100000
#define GPU0_SS_GPU0_CLK	0x62000

#define GPU0_SS_GPU0_CLK_OUT_SEL	(1<<8)
